...
@$codigo = $_POST["codigo"];
$queryALTERAR = "UPDATE contatos SET ID=1";
...
if($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  if (!empty($_POST["codigo"])) {
    if(mysqli_num_rows($result) > 0){
      mysqli_query ($conn, $queryALTERAR);
      mysqli_close ($conn);
      $sucess = 'SUCESSO! Alterado.';
    }
    }else{
    echo "<h1>ID de utilizador não existe.</h1>";
    echo $queryALTERAR;
  }
}
...
<body>
  ...
  <section id="hero" class="d-flex align-items-center justify-content-center">
        ...
        <main>
            <h1><strong>Alterar Utilizadores</strong></h1>
    ...
    <div class="table2"><!---------------------------------------------- contentor do formulario ------------------------>
        <form class="form-horizontal" role="form" name="frmInserir" method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>">
            <div class="row mb-3">
              <label class="col-sm-2 col-form-label col-form-label-lg" for="codigo">Alterar</label>
              <div class="col-sm-10">
            ...
            <div class="row mb-3" >
              <div class="col-sm-10 offset-sm-2">
                <div class="btn-group">
                <button class="btn btn-success" name="gravar" type="submit" value="Submit">Alterar</button>
